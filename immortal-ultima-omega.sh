...
guard_log "Patrol started (v6.0) — ABCDE triage active"
...
guard_log "ABCDE triage complete — v6.0 guardian active"
GUARDEOF
chmod +x "$GUARDIAN"
...
log "Guardian deployed (v6.0 enhanced with ABCDE triage)"
...
[0;36m [Step 5] GPU Modprobe Config[0m
[0;32m[✓ PLAN A][0m NVIDIA modprobe written (explicit sync enabled via modeset=1)
[0;36m [Step 6] NVMe PS0 Lock[0m
[0;32m[✓ PLAN A][0m NVMe PS0 lock applied (Desktop)
[0;36m [Step 7] USB Stability + Touchpad Keep-Alive[0m
[0;32m[✓ PLAN A][0m USB + touchpad rules applied
[0;36m [Step 8] IO Schedulers[0m
[0;32m[✓ PLAN A][0m IO scheduler rules applied
[0;36m [Step 9] Seagate EXOS APM Disable[0m
[0;32m[✓ PLAN A][0m EXOS APM disabled
[0;36m [Step 10] fstab — noatime + lazytime[0m
[0;32m[✓ PLAN A][0m fstab updated
[0;36m [Step 11] ZRAM — Dynamic sizing (v4.0)[0m
[0;32m[✓ PLAN A][0m ZRAM configured — dynamic size: 15 GB (v4.0)
[0;36m [Step 12] Tier-2 Swapfile on secondary SSD[0m
[0;36m [Step 13] Sysctl[0m
...
[0;32m[✓ PLAN A][0m Guardian deployed (v6.0 enhanced with ABCDE triage)
[0;36m [Step 21] DNF5 Optimization[0m
[0;32m[✓ PLAN A][0m DNF5 optimized
[0;36m [Step 22] Performance Engine: Tuned Immortal Ultima (v6.0)[0m
[0;32m[✓ PLAN A][0m Enabled: Tuned performance engine
[0;32m[✓ PLAN A][0m Tuned immortal-ultima profile activated
[0;36m [Step 23] PipeWire Low-Latency Audio (v4.0)[0m
[0;32m[✓ PLAN A][0m PipeWire low-latency configured (audio perfection)
[0;36m [Step 24] Deskflow Auto-Allow KVM PC[0m
[0;36m [Step 25] Firefox Latency Fix[0m
[0;36m [Step 26] Companion Tools — immortal-status & immortal-health-check (v6.0)[0m
[0;32m[✓ PLAN A][0m Companion tools installed — run 'immortal-status' anytime
[0;36m [Step 27] Kernel Hardening (v6.0)[0m
[0;36m [Step 28] Entropy Improvement (haveged)[0m
[0;36m [Step 29] FINAL REPORT & SELF-REGENERATION (v6.0)[0m
